...
class PlusCourtTest {
	...
	@Test
	void testDijkstraIndi() throws NumberFormatException,IOException {
		IPCC algo = new PCCDijkstra();
		assertTrue(GraphImporter.comparer(REPERTOIRE_ENONCE+REPERTOIRE_DIJKSTRA + "g-10-1.txt", REPERTOIRE_REPONSE+REPERTOIRE_DIJKSTRA + "g-10-1.txt".replace('g', 'r'), algo));
	}
	...
	@Test
	void testBellmanIndi() throws NumberFormatException, IOException {
		IPCC algo = new PCCBellman();
		assertTrue(GraphImporter.comparer(REPERTOIRE_ENONCE+REPERTOIRE_BELLMAN + "g-100-2.txt", REPERTOIRE_REPONSE+REPERTOIRE_BELLMAN + "g-100-2.txt".replace('g', 'r'), algo));
	}
}
